    ...
    <section className='py-16 px-4 lg:px-0'>
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="relative flex-1">
            <img src={womensCollection} alt="womens" className='w-full h-[700px] object-cover' />

            <div className="absolute bottom-8 left-8 bg-gray-200 bg-opacity-90 p-4">
        ...
        {/* Mens collection */}
        <div className="relative flex-1">
            <img src={mensCollection} alt="mens" className='w-full h-[700px] object-cover' />
